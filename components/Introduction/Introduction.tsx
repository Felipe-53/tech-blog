      ...
      <div className="flex items-center">
        ...
        <div className="flex flex-col">
          <p className="text-darkfont text-lg">
            Escrevendo sobre desenvolvimento Full Stack com <span className="text-javascript">JavaScript</span>, <span className="text-typescript">TypeScript</span> e todas as tecnologias fantásticas produzidas nesse ecossistema.
            <Link href="/sobre">
